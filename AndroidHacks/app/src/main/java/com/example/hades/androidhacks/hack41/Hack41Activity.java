 ...
 ******************************************************************************/
package com.example.hades.androidhacks.hack41;
...
import com.example.hades.androidhacks.hack41.data.table.Article;
import com.example.hades.androidhacks.hack41.data.table.ArticleAuthor;
import com.example.hades.androidhacks.hack41.data.table.ArticleCategory;
import com.example.hades.androidhacks.hack41.data.table.Author;
import com.example.hades.androidhacks.hack41.data.table.Category;
import com.example.hades.androidhacks.hack41.data.DatabaseHelper;
 ...
 */
public class Hack41Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hack_41_main);
    ...
    private class MainAdapter extends BaseAdapter {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Hack41Activity.this.startActivity(new Intent(Hack41Activity.this,
        ...
        private MainAdapter(ArticleListModel model) {
            this.model = model;
            inflater = LayoutInflater.from(Hack41Activity.this);
        }
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == TYPE_CATEGORY) {
                ...
                if (view == null)
                    view = inflater.inflate(R.layout.activity_hack_41_list_category, null);
                // Just fill out the display text for a CategoryModel
                ((TextView) view).setText(model.getText());
            } else {
                Article article = (Article) item;
                if (view == null)
                    view = inflater.inflate(R.layout.activity_hack_41_list_item, null);
    ...
    private static class LoadArticleListTask extends
        ...
        private Hack41Activity host;
        private ArticleListModel payload;
        private boolean done;

        private LoadArticleListTask(Hack41Activity host) {
            this.host = host;
        }
        ...
        private void insertSampleData(DatabaseHelper helper)
            ...
            for (int i = 0; i < SAMPLE_COUNT; i++) {
                ...
                // activity_hack_41_article
                if (i == 0) {
                    // Let's make the first activity_hack_41_article have many authors.
                    for (Author author : authors)
                        articleAuthorDao.create(new ArticleAuthor(author, article));
                } else {
                    // Otherwise, we'll assign a single author to the activity_hack_41_article.
                ...
                // activity_hack_41_article.
                if (i == 15) {
                    // For some diversity, we will put this activity_hack_41_article in a sub
                    // category
        ...
        public void attach(Hack41Activity newActivity) {
            host = newActivity;
            if (done)
