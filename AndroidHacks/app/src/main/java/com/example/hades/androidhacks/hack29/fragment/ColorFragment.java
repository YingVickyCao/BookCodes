 ...
 ******************************************************************************/
package com.example.hades.androidhacks.hack29.fragment;
...
public class ColorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.activity_hack_29_color_fragment, container, false);
        final TextView textView = rootView.findViewById(R.id.color_fragment_text);
