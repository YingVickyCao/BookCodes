...
public class ImageResizer extends ImageWorker {
    ...
    /**
     * The activity_hack_43_main processing method. This happens in a background task. In this case
     ...
     *
     * @param options   An options object with out* params already populated (run through
