 ...
 * implementation with a activity_hack_40_list.
 */
public class TestListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hack_40_list);
        ...
        // at once.
        cacheParams.memCacheSize = 1024 * 1024 * Utils.getDeviceMemory(this) / 3;
    ...
    static class TestAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                view = LayoutInflater.from(context).inflate(R.layout.activity_hack_40_list_item, null);
