...
import com.example.hades.androidhacks.hack41.data.table.Comment;
...
public class ArticleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hack_41_article);
    ...
    private void addCommentPrompt() {
        View body = LayoutInflater.from(this).inflate(
                R.layout.activity_hack_41_comment_dialog, null);
        ...
        private ArticleModel(Article article) {
            if (article == null)
                throw new IllegalArgumentException(
                        "Passed in activity_hack_41_article must be non-null!");
            ...
            return helper.callInTransaction(new Callable<ArticleModel>() {
                ...
                public ArticleModel call() throws SQLException {
                    ...
                    PreparedQuery<ArticleAuthor> query = authorDao.queryBuilder()
                            .where().eq(ArticleAuthor.COLUMN_ARTICLE_ID, articleId)
                            .prepare();
                    // Now, run the query
     ...
     * @param articleId  The ID of the activity_hack_41_article.
