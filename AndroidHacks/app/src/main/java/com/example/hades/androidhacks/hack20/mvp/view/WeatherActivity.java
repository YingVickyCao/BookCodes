...
import com.example.hades.androidhacks.hack20.mvp.model.WeatherModelImpl;
import com.example.hades.androidhacks.hack20.mvp.presenter.IWeatherPresenter;
...
public class WeatherActivity extends Activity implements IWeatherView, View.OnClickListener {
    ...
    private void requestWeatherInfo(View view) {
        mPresenter.setWeatherModel(new WeatherModelImpl());
