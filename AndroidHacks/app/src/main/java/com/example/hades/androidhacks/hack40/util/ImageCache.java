...
public class ImageCache {
    ...
    private static final CompressFormat DEFAULT_COMPRESS_FORMAT_WHEN_WRITE_IMAGE_2_DISK_CACHE = CompressFormat.JPEG;
     ...
     * exist.
     */
    public static ImageCache getImageCacheStoredInRetainFragment(final FragmentActivity activity, final String uniqueName) {
        return getImageCacheStoredInRetainFragment(activity, new ImageCacheParams(uniqueName));
    }

    public static ImageCache getImageCacheStoredInRetainFragment(final FragmentActivity activity, ImageCacheParams cacheParams) {
        final RetainFragment retainFragment = RetainFragment.getRetainFragmentInstance(activity.getSupportFragmentManager());
        return retainFragment.getImageCacheInstance(activity, cacheParams);
    }
    ...
    public static class ImageCacheParams {
        ...
        public CompressFormat compressFormat = DEFAULT_COMPRESS_FORMAT_WHEN_WRITE_IMAGE_2_DISK_CACHE;
